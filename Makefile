DUSK_VERSION := $(shell cat DUSK_VERSION)
DUSK_DEPS := $(wildcard DUSK_*)
DOCKER_TAG_PREFIX := rzuckerm/dusk:$(DUSK_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(DUSK_DEPS)
